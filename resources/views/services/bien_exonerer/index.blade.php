...
<div class="content-page">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                <a href="{{route('bienexonerer.create')}}" class="btn btn-danger">Nouvelle attestation +
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="datatable-buttons"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('bienexonerer.show',$item->id )}}"
                                                    class="btn btn-warning">Voir </a>
                                                <a href="{{route('bienexonerer.edit',$item->id )}}"
                                                    class="btn btn-primary">Modifier </a>
                                                <form action="{{route('bienexonerer.destroy',$item->id )  }}"
    ...
    <footer class="footer">
        © 2019 - 2020 Hexzy <span class="d-none d-md-inline-block"> - Crafted with <i
