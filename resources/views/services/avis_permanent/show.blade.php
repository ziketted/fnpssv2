            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        @foreach ($avispermanents as $item)
                        @if (!is_null($item->arrete_min) )
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="card m-b-30 text-white bg-secondary">
                                    <div class="card-body">
                                        ...
                                        <a href="{{Storage::url($item->arrete_min)}}" class="btn btn-primary"
                                            download="statut"><i class="ion ion-md-folder-open"></i> Téléchargez
                        ...
                        <div class="row mt-2">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de la convention de partenariat avec le gouvernement
                                            de la RDC. (pdf)
                                        </p><a href="{{Storage::url($item->partenariat)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Liste des droits , taxes et redevances concernés par
                                            l’exonération.(pdf)
                                        </p><a href="{{Storage::url($item->liste)}}" class="btn btn-outline-danger"><i
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        </p><a href="{{Storage::url($item->rapport_exoneration)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du rapport concernant les exonérations des droits,
                                            taxes et redevances précédants la nouvelle demande et approuvée par le
                                            Fnpss. (pdf)
                                        </p><a href="{{Storage::url($item->rapport_exoneration)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
