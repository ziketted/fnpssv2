                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                <a href="{{route('avispermanent.create')}}" class="btn btn-danger">Nouvelle attestation
                                    +
                                </a>
                            </div>
                        </div>
                                ...
                                <table id="datatable-buttons"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('avispermanent.show',$item->id )}}"
                                                    class="btn btn-warning">Voir </a>
                                                <a href="{{route('avispermanent.edit',$item->id )}}"
                                                    class="btn btn-primary">Modifier </a>
                                                <form action="{{route('avispermanent.destroy',$item->id )  }}"
