        ...
        <div class="page-content-wrapper ">
            ...
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                <a href="{{route('convention.create')}}" class="btn btn-danger">Nouvelle attestation +
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="alert alert-info alert-dismissible fade show">
                    ...
                    <h3>Demande de convention de partenariat avec le gouvernement.</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('convention.edit',$item->id )}}"
