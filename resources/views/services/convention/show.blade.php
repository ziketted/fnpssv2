            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        @if (!is_null($item->convention_partenariat) )
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="card m-b-30 text-white bg-secondary">
                                    <div class="card-body">
                                        ...
                                        <a href="{{Storage::url($item->convention_partenariat)}}"
                                            class="btn btn-primary" download="Convention partenariat"><i
                                                class="ion ion-md-folder-open"></i> Téléchargez
                                            la convention de partenariat.</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie attestation enrôlement(pdf)
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie plan(pdf)
                                        </p><a href="{{Storage::url($item->copie_plan)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie rapport (pdf)
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du projet (pdf)
