                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="m-t-0 m-b-30"><b>Mettre à jour la demande n° {{$item->id}} à soumettre</b>
                                </h4>

                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="m-r-15">
                                            <form action="{{ route('enrolement.update',$item->id ) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <p class="text-secondary">Lettre adressée au DG, copie le ministre
                                                        des
                                                        affaires </p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="copie_statut" accept="application/pdf"
                                                        required>
                                                </div>
                                                <div class="form-group">
