            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        @if (!is_null($item->attestation_enrolement) )
                        <div class="row mt-3">
                            <div class="col-lg-10">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie des statuts notaries(pdf)
                                        </p><a href="{{Storage::url($item->copie_statut)}}"
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’Arrêté Ministériel des Affaires Sociales(pdf)
                                        </p><a href="{{Storage::url($item->copie_arrete_aff_soc)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’Arrêté du Ministère de la Justice (pdf)
                                        </p><a href="{{Storage::url($item->copie_arrete_justice)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du Plan d’Action pour l’année en cours (pdf)
                                        </p><a href="{{Storage::url($item->copie_plan_action)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du rapport annuel d’activités (pdf)
                                        </p><a href="{{Storage::url($item->copie_rapport_annuel)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du numéro d’impôt (pdf)
                                        </p><a href="{{Storage::url($item->copie_numero_impot)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
