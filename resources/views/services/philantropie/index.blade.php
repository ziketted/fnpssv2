            ...
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <a href="{{route('philantropie.create')}}" class="btn btn-danger">Nouvelle attestation +
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="alert alert-info alert-dismissible fade show">
                    ...
                    <h3>Demande d'attestation d'exonération.</h3>
                                ...
                                <table id="datatable-buttons"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('philantropie.show',$item->id )}}"
                                                    class="btn btn-warning">Voir </a>
                                                <a href="{{route('philantropie.edit',$item->id )}}"
                                                    class="btn btn-primary">Modifier </a>
                                                <form action="{{route('philantropie.destroy',$item->id )  }}"
