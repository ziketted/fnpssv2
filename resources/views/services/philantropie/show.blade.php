            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        @foreach ($philantropies as $item)
                        @if (!is_null($item->certificat_philantropie) )
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="card m-b-30 text-white bg-secondary">
                                    <div class="card-body">
                                        ...
                                        <a href="{{Storage::url($item->certificat_philantropie)}}"
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du certificat d’exonération des biens concernés par
                                            la vente (pdf)
                                        </p><a href="{{Storage::url($item->certificat)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du rapport d’activités de l’année écoulée(pdf)
                                        </p><a href="{{Storage::url($item->rapport_activite)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de la grille de prix proposé. (pdf)
                                        </p><a href="{{Storage::url($item->grille)}}" class="btn btn-outline-danger"><i
                                                class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de rapport approuvée par le Fnpss, d’achat ou de
                                            vente précédant la nouvelle demande. (pdf)
                                        </p><a href="{{Storage::url($item->rapport_approuve)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
