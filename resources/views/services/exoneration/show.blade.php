            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        @if (!is_null($item->certificat_exoneration) )
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="card m-b-30 text-white bg-secondary">
                                    <div class="card-body">
                                        ...
                                        <a href="{{Storage::url($item->certificat_exoneration)}}"
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Lettre adressée au DG, copie le ministre des affaires (pdf)
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’accord de siège (pdf)
                                        </p><a href="{{Storage::url($item->accord)}}" class="btn btn-outline-danger"><i
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’attestation des biens à exonérer(pdf)
                                        </p><a href="{{Storage::url($item->attestation)}}"
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’avis favorable pour l’exonération du Min.
                                            sectoriel (pdf)
                                        </p><a href="{{Storage::url($item->copie_avis)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Liste de colisage (pdf)
                                        </p><a href="{{Storage::url($item->liste_colisage)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Projet d’utilisation du don ou des biens acquis (pdf)
                                        </p><a href="{{Storage::url($item->projet)}}" class="btn btn-outline-danger"><i
                                                class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de la lettre de transport maritime ( BL ) ou Aérien
                                            (LTA) ou terrestre (pdf)
                                        </p><a href="{{Storage::url($item->trasnport)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie de l’attestation des dons ou la facture d’achat (pdf)
                                        </p><a href="{{Storage::url($item->facture)}}" class="btn btn-outline-danger"><i
                                                class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <p class="card-text">Copie du rapport d’affectation des biens exonérés précedant
                                            la nouvelle demande et approuvée par le Fnpss. (pdf)
                                        </p><a href="{{Storage::url($item->affectation)}}"
                                            class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"></i>
                                            Télécharger
                                        </a>
                                    </div>
