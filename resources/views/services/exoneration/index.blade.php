            ...
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <a href="{{route('exoneration.create')}}" class="btn btn-danger">Nouvelle attestation +
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="datatable-buttons"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('exoneration.show',$item->id )}}"
                                                    class="btn btn-warning">Voir </a>
                                                <a href="{{route('exoneration.edit',$item->id )}}"
                                                    class="btn btn-primary">Modifier </a>
                                                <form action="{{route('exoneration.destroy',$item->id )  }}"
