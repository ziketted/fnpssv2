                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="m-r-15 mt-4">
                            <form action="{{ route('administration.validationBienexonerer') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="relative mt-1" style="display: none;">
                                    <input type="text" id="id_bienexonerer" name="id_bienexonerer"
                                        value="{{$item->id}}" />
                                </div>

                                <div class="form-group">
                                    <p>Attestation des biens à exonérer.
                                        <code> Soumettre la convention au requérant.</code>
                                    </p>
                                    <input type="file" name="attestation_bien_exonerer" accept="application/pdf">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge "><a href="{{Storage::url($item->copie_convention)}}"
                                        class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"
                                            download></i>
                                        Télécharger
                                    </a></span>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Copie de rapport d'affectation
                                <a href="{{Storage::url($item->copie_rapport_affectation)}}"
                                    class="btn btn-outline-danger"><i class="ion ion-md-cloud-download"
                                        download="copie_rapport"></i>
                                    Télécharger
                                </a>
                            </li>
